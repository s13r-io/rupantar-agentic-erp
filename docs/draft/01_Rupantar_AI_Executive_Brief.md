...
> **This document is extracted from the Full Proposal. It is designed to work as a complete standalone document — all key numbers, tables, and decisions are self-contained. The Full Proposal provides detailed evidence for each claim made here.**
